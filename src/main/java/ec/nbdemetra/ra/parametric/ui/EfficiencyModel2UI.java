...
import ec.nbdemetra.ra.parametric.ui.html.HtmlEfficiencyModel2;
 ...
 * @author aresda
 */
public class EfficiencyModel2UI<D extends IProcDocument> extends HtmlItemUI<IProcDocumentView<D>, ComponentMatrix> {

    @Override
    protected IHtmlElement getHtmlElement(IProcDocumentView<D> host, ComponentMatrix information) {
        return new HtmlEfficiencyModel2((ParametricSpecification) host.getDocument().getSpecification(), information);
    }
}
