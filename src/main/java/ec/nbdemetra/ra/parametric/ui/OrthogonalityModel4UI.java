...
import ec.nbdemetra.ra.parametric.ui.html.HtmlOrthogonalityModel4;
 ...
 * @author aresda
 */
public class OrthogonalityModel4UI<D extends IProcDocument> extends HtmlItemUI<IProcDocumentView<D>, ComponentMatrix> {

    @Override
    protected IHtmlElement getHtmlElement(IProcDocumentView<D> host, ComponentMatrix information) {
        return new HtmlOrthogonalityModel4((ParametricSpecification) host.getDocument().getSpecification(),information);
    }    
}
