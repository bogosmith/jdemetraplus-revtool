...
import ec.nbdemetra.ra.parametric.ui.html.HtmlOrthogonalityModel2;
 ...
 * @author aresda
 */
public class OrthogonalityModel2UI<D extends IProcDocument> extends HtmlItemUI<IProcDocumentView<D>, ComponentMatrix> {

    @Override
    protected IHtmlElement getHtmlElement(IProcDocumentView<D> host, ComponentMatrix information) {
        return new HtmlOrthogonalityModel2((ParametricSpecification) host.getDocument().getSpecification(),information);
    }
}
