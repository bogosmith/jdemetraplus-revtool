...
import ec.nbdemetra.ra.parametric.ui.html.HtmlOrthogonalityModel1;
 ...
 * @author aresda
 */
public class OrthogonalityModel1UI<D extends IProcDocument> extends HtmlItemUI<IProcDocumentView<D>, ComponentMatrix> {

    @Override
    protected IHtmlElement getHtmlElement(IProcDocumentView<D> host, ComponentMatrix information) {
        return new HtmlOrthogonalityModel1((ParametricSpecification) host.getDocument().getSpecification(),information);
    }
}
