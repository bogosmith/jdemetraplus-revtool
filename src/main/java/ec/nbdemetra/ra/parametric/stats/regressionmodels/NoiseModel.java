...
/**
 * Regression techniques can also be used to determine whether revisions should be classified as ‘news’ or ‘noise’:
 * @see NoiseModel
 * @author aresda
 */
public class NoiseModel extends AbstractRegressionModel {
    ...
    public OLSMultipleLinearRegression regressionSignal(RevisionId revId) throws MathIllegalArgumentException, TooSmallSampleException {
        clear();
        buildXY(revId.getLatestTsData(), revId.getRevisionTsData());
        try {
